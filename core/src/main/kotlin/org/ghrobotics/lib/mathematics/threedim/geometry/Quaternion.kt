...
data class Quaternion(
    ...
    operator fun get(componentId: Int) = when (componentId) {
        0 -> x
        1 -> y
        2 -> z
        3 -> w
    ...
    fun transform(other: Translation3d) = Translation3d(
        w * w * other.x + 2.0 * y * w * other.z - 2.0 * z * w * other.y + x * x * other.x + 2.0 * y * x * other.y +
            2.0 * z * x * other.z - z * z * other.x - y * y * other.x,
        2.0 * x * y * other.x + y * y * other.y + 2.0 * z * y * other.z + 2.0 * w * z * other.x - z * z * other.y +
            w * w * other.y - 2.0 * x * w * other.z - x * x * other.y,
        2.0 * x * z * other.x + 2.0 * y * z * other.y + z * z * other.z - 2.0 * w * y * other.x - y * y * other.z +
            2.0 * w * x * other.y - x * x * other.z + w * w * other.z,
    )
