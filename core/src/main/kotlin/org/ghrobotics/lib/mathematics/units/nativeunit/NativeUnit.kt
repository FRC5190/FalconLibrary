...
val SIUnit<NativeUnitVelocity>.nativeUnitsPer100ms get() = inNativeUnitsPer100ms()
@Deprecated("", ReplaceWith("inSTUPer100ms()"))
val SIUnit<NativeUnitVelocity>.STUPer100ms get() = inSTUPer100ms()
...
val SIUnit<NativeUnitAcceleration>.nativeUnitsPer100msPerSecond get() = inNativeUnitsPer100msPerSecond()
@Deprecated("", ReplaceWith("inSTUPer100msPerSecond()"))
val SIUnit<NativeUnitAcceleration>.STUPer100msPerSecond get() = inSTUPer100msPerSecond()
