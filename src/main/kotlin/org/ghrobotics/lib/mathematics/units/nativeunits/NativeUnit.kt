...
fun <T : SIUnit<T>> T.toNativeUnit(model: NativeUnitModel<T>) = model.toNativeUnit(this)
...
class NativeUnit(
    ...
    fun <T : SIUnit<T>> fromNativeUnit(model: NativeUnitModel<T>) = model.fromNativeUnit(this)
