...
abstract class FalconCTRE<T : SIUnit<T>>(
    ...
    private var lastDemand = Demand(ControlMode.Disabled, 0.0, DemandType.Neutral, 0.0)
    ...
    override fun setNeutral() = sendDemand(Demand(ControlMode.Disabled, 0.0, DemandType.Neutral, 0.0))
