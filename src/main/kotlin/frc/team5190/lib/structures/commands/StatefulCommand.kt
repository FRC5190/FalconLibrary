...
@Deprecated("", ReplaceWith("StatefulValue(value)", "frc.team5190.lib.structures.utils.statefulvalue.StatefulValue"))
fun condition(value: Boolean): Condition = StatefulValue(value)

@Deprecated("", ReplaceWith("StatefulValue(frequency, block)", "frc.team5190.lib.structures.utils.statefulvalue.StatefulValue"))
fun condition(frequency: Int = 50, block: () -> Boolean): Condition = StatefulValue(frequency, block)

@Deprecated("", ReplaceWith("this or StatefulValue(block)", "frc.team5190.lib.structures.utils.statefulvalue.or", "frc.team5190.lib.structures.utils.statefulvalue.StatefulValue"))
infix fun Condition.or(block: () -> Boolean) = this or StatefulValue(block)

@Deprecated("", ReplaceWith("this and StatefulValue(block)", "frc.team5190.lib.structures.utils.statefulvalue.and", "frc.team5190.lib.structures.utils.statefulvalue.StatefulValue"))
