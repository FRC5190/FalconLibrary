...
class TrajectoryGeneratorTest {
    ...
    fun testTrajectoryGenerationAndConstraints() {
        ...
        while (!iterator.isDone) {
            ...
            val ac = pt.state.velocity.value.pow(2) * pt.state.state.curvature.curvature.value
            ...
            assert(pt.state._acceleration * pt.state.state.curvature._curvature +
                    pt.state._velocity.pow(2) * pt.state.state.curvature.dkds
